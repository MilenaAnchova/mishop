...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    private function _populateStoreCategories()
    {
        ...
        $categories = $this->categoryCollectionFactory->create()
            ->setStoreId($storeId)
            ->addAttributeToFilter('path', array( //### ELEGENTO hack for filtering categories
                array('like' => "1/{$rootCategoryId}/23/%"), //women category id
                array('like' => "1/{$rootCategoryId}/23"), //women category id
                array('like' => "1/{$rootCategoryId}/26/%"), // men category id
                array('like' => "1/{$rootCategoryId}/26"), // men category id
                array('like' => "1/{$rootCategoryId}/240/%"), // child category id
                 array('like' => "1/{$rootCategoryId}/240"))) // child category id
    ...
    public function addToCartPushData($qty, $product)
    {
        ...
        $productData['price'] = number_format($product->getPriceInfo()->getPrice('final_price')->getValue() * 1.24, 2, '.', ''); //### ELEGENTO hack to add tax to price manually
    ...
    public function getGtmCategoryFromCategoryIds($categoryIds)
    {
        ...
        $categoryId = end($categoryIds); //### ELEGENTO hack to fetch last category id instead of first
        $categoryPath = '';
